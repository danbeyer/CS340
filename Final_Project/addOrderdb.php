...
the $_POST variable has to match " <select name="customerID"> "

before : //if(!($stmt->bind_param("isi",$_POST['orderID'],$_POST['orderDate'],$_POST['cid'])))
	---------------->    ----------------------------------->               ------------^
The $_POST['cid'] doesnt match the selector name "customerID" from the HTMLexampleDB code	


after  : if(!($stmt->bind_param("isi",$_POST['orderID'],$_POST['orderDate'],$_POST['customerID'])))
------------------------------------------------------------------------------Corrected--^              

*/


if(!($stmt->bind_param("isi",$_POST['orderID'],$_POST['orderDate'],$_POST['customerID'])))	
{
